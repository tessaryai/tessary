...
classifier-quality-doc|scripts/check-classifier-quality-doc.sh|RUN_ENV:CQ_DOC=tessary-paid/devdocs/reference/classifier-quality.md CQ_MODELS=tessary-paid/classify-service/models.json|RUN|the open manifest binds the public groundedness head and devdocs/reference/classifier-quality.md carries its pins; the paid disposition adds the overlay's page and manifest

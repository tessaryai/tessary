...
import ai.tessary.evals.tenant.ProjectDeleteJobRow;
...
public class ProjectPurgeWorker {
    ...
    /**
     * Rows per statement. Matched to {@code evals.retention.batch-size} — the same trade-off against the
    ...
    @Scheduled(fixedDelayString = "${evals.project-delete.heartbeat-ms:15000}", initialDelayString = "30000")
    public void tick() {
        try {

 ...
 * when {@code evals.metering.storage-enabled} is set: its billable basis (bytes vs row-count vs
...
public enum UsageUnit {
    ...
    /** Storage/retention LEVEL — snapshotted rows at rest; gated behind {@code evals.metering.storage-enabled}. */
    STORAGE("storage");
    ...
    public static UsageUnit fromWire(String wire) {
        ...
        throw new EvalsException(MeteringError.UNKNOWN_UNIT, wire);
    }
}

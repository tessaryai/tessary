...
import ai.tessary.evals.retention.RetentionResolver.DataClass;
import ai.tessary.evals.retention.RetentionResolver.EffectiveRetention;
...
public class RetentionSweeper {
    ...
    @Scheduled(fixedDelayString = "${evals.retention.interval-ms:3600000}", initialDelayString = "60000")
    public void sweep() {

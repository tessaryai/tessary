...
import ai.tessary.evals.storage.TraceV2Repository.RollupQueue;
...
public class TraceRollupReaper {
    ...
    @Scheduled(
            fixedDelayString = "${evals.ingest.substrate.rollup-reap-interval-ms:60000}",
            initialDelayString = "${evals.ingest.substrate.rollup-reap-interval-ms:60000}")
    public void tick() {
        try {
            sweepOnce();

...
import ai.tessary.evals.ingest.substrate.v2.SpanLateness;
import ai.tessary.evals.ingest.substrate.v2.TraceRollupMetrics;
...
public class IngestThroughputReporter {
    ...
    @Scheduled(fixedDelayString = "${evals.ingest.substrate.report-ms:60000}", initialDelayString = "60000")
    public void report() {

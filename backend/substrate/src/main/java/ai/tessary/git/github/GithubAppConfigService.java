 ...
 * overwrites whatever {@code TESSARY_GIT_GITHUB_*} handed {@link GithubAppProperties} at Spring-binding
...
public class GithubAppConfigService {
    ...
    public void loadOnStartup() {
        ...
        if (!secretBox.isConfigured()) {
            // A row exists but we can't open it (no TESSARY_SECRET_KEY). Fail closed to the pre-#860

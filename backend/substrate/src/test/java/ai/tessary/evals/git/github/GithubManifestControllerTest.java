...
class GithubManifestControllerTest {
    ...
    void manifestUrl_refusesWhenAnAppIsAlreadyConfigured() {
        ...
        ai.tessary.evals.open.errors.EvalsException e = org.junit.jupiter.api.Assertions.assertThrows(
                ai.tessary.evals.open.errors.EvalsException.class, () -> controller.manifestUrl(ctx, "acme", "web"));
    ...
    void callback_reusedOrExpiredCode_surfacesDistinctError() {
        ...
        when(exchange.convert("reused"))
                .thenThrow(new ai.tessary.evals.open.errors.EvalsException(
                        ai.tessary.evals.open.errors.GitError.MANIFEST_CONVERSION_FAILED));
    ...
    void callback_invalidState_throwsRatherThanRedirecting() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(
                ai.tessary.evals.open.errors.EvalsException.class, () -> controller.callback("garbage", "code"));
    }
}

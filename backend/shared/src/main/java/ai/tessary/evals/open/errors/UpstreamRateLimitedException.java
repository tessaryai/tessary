 ...
 * {@link ai.tessary.evals.run.TraceHydrator} — back off for that long instead of
 ...
 * like the plain {@link EvalsException} it replaces.
 */
public class UpstreamRateLimitedException extends EvalsException {

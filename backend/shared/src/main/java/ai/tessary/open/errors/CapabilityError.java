 ...
 * server-side gate saying a capability is off for this org; {@code UNKNOWN} guards the
 * capability-override write path; {@code QUOTA_EXCEEDED} is the hard limit a metered request hits
 * past its cap, declared here because substrate ingest reads it to map a quota refusal onto a gRPC
 * status even though nothing in this build throws it.
 */

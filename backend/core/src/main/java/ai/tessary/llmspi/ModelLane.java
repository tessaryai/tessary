 ...
 * ({@code tessary.judge.default-bedrock-model-id}), so there was no way to put the high-volume grading
 ...
 * ({@code tessary.judge.platform-bedrock.enabled}, gating {@code ChatModelFactory#resolvePlatformBedrock}).

 ...
 * {@code evals.telemetry.enabled} / {@code EVALS_TELEMETRY_ENABLED} (Spring relaxed binding).
 *
 * <p>Replaces {@code evals.analytics.*} (deleted with the Mixpanel stack, #858). There is no token
 ...
 */
@Component
@ConfigurationProperties(prefix = "evals.telemetry")

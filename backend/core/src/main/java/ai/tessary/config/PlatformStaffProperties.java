...
/**
 * The platform-staff allowlist, bound from {@code tessary.platform.staff-emails} — the identities that may
 ...
 *
 * <p><b>Empty means nobody.</b> Unlike a capability default, an unset {@code TESSARY_PLATFORM_STAFF_EMAILS}

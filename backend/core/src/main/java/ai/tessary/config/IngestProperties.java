...
/**
 * Ingestion tuning, bound from {@code tessary.ingest.*}. Today this carries the
 ...
 *
 * <p>Distinct from {@link TessaryProperties} (DB connection + the bundled-yaml seed
 * anchor) by concern, mirroring the per-prefix split used by {@code ObserverProperties}
 * / {@code SynthProperties}.
 */
@Component
@ConfigurationProperties(prefix = "tessary.ingest")

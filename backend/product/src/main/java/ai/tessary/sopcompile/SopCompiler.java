 ...
 * them. It is a package with one file in it on purpose. {@code ai.tessary.compile} was the other
 ...
 * open {@code ai.tessary.sop} package: one class of paid vocabulary deliberately left in the open

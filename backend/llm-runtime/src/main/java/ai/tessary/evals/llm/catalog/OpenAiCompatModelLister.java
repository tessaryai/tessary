 ...
 *
 * <p>One instance covers {@link ai.tessary.evals.llm.ModelProvider#OPENAI}, {@code MOONSHOT},
 * {@code GEMINI}, {@code GLM}, {@code GROK} and {@code CUSTOM} — each constructed with its own fixed
 * {@code vendor} label, because unlike {@link ai.tessary.evals.llm.catalog.SupportedMaker}-filtered

 ...
 * {@link ai.tessary.evals.llm.ModelCatalog#mergeLive} overlays onto the static capability table.
 *
 ...
 * @param vendor the model's maker, matching {@link ai.tessary.evals.llm.ModelCatalog.CatalogEntry}'s

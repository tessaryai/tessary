...
public class ProjectModelSettingController {
     ...
     * ai.tessary.evals.pricing.PlatformCallPricer} prices a completed sandbox run from — not a static
     ...
     * ai.tessary.evals.pricing.ModelRates} documents.
     */
    ...
    /**
     * A (#994): one model's rate, resolved the same way {@link ai.tessary.evals.pricing.PlatformCallPricer}
    ...
    private ModelRateView rateView(BedrockModelProfile.ModelDescriptor d) {
        Optional<ai.tessary.evals.pricing.ModelRate> rate =

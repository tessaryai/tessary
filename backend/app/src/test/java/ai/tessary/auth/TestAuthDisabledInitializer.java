 ...
 * credential as an indirect toggle for auth enforcement.</b> Override {@code tessary.auth.disabled}
...
public class TestAuthDisabledInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    public void initialize(ConfigurableApplicationContext applicationContext) {
        ...
        // tessary.auth.disabled=false to opt into real enforcement, an initializer running AFTER

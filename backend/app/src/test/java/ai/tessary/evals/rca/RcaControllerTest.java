...
import ai.tessary.evals.cases.CaseDetection;
import ai.tessary.evals.cases.CaseKey;
import ai.tessary.evals.cases.CaseRepository;
...
class RcaControllerTest {
    ...
    void anUnknownCaseOrFindingIsRejected() {
        ...
        EvalsException unknownCase = assertThrows(
        ...
        EvalsException unknownFinding = assertThrows(
                EvalsException.class,
                () -> trigger.trigger(

...
import ai.tessary.evals.gate.PreDeployCheckRepository;
import ai.tessary.evals.gate.PreDeployCheckRow;
...
class PreDeploySignalLoopIntegrationTest {
    ...
    static void props(DynamicPropertyRegistry r) {
        ...
        r.add("evals.predeploy.enabled", () -> "true"); // activate the loop (write + read)
    }
    ...
    @Autowired
    ai.tessary.evals.classifier.ClassifierService signalService;

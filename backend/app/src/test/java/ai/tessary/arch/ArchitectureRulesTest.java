...
public class ArchitectureRulesTest {
    ...
    // config (TessaryProperties) and on each other across slices, so the feature graph is cyclic by
     ...
     * option — {@code @AnalyzeClasses} is rooted at {@code ai.tessary} and the paid jar is not on
     ...
     *
     * <p>{@code ai.tessary.classifier.conformance} used to keep a shrunk wire seam open —
    ...
    /**
     * Every rule here scans {@code ai.tessary}, which since the module split lives almost

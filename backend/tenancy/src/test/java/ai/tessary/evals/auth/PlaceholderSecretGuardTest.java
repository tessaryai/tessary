...
class PlaceholderSecretGuardTest {
    ...
    private static PlaceholderSecretGuard guard(
        ...
        EvalsProperties evals = new EvalsProperties();
        evals.setSiteDomain(siteDomain);
        evals.setSecretKey(secretKey);
        ...
        return new PlaceholderSecretGuard(evals, auth, rca);
    }
    ...
    void verify_refusesTheBootWhenADomainMeetsThePlaceholderSealingKey() {
        ...
        assertTrue(message.contains("EVALS_SECRET_KEY"));
        assertTrue(!message.contains("EVALS_AUTH_COOKIE_PASSWORD"));
    }
    ...
    void verify_bootsWithAWarningOnALocalhostInstance() {
        ...
        assertTrue(event.getFormattedMessage().contains("EVALS_AUTH_COOKIE_PASSWORD"));
        assertTrue(event.getFormattedMessage().contains("EVALS_SECRET_KEY"));
    }
    ...
    void theLauncherPlaceholderRefusesADomainedBootLikeTheOtherTwo() {
        ...
        assertTrue(
                refusalOf(g).contains("EVALS_OBSERVER_AGENTIC_LAUNCHER_API_KEY"),
        ...
        assertTrue(
                appender.list.stream()
                        .anyMatch(e -> String.valueOf(e.getFormattedMessage())
                                .contains("EVALS_OBSERVER_AGENTIC_LAUNCHER_API_KEY")),

...
import ai.tessary.evals.tenant.AuditLogRepository;
import ai.tessary.evals.tenant.InvitationRepository;
import ai.tessary.evals.tenant.OrgInvitation;
...
import ai.tessary.evals.tenant.SignupPolicy;
...
class SignupPolicyServiceTest {
    ...
    private void refused(String email) {
        EvalsException e = assertThrows(EvalsException.class, () -> service.admit(email, null));

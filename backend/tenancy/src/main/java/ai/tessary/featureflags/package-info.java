 ...
 * One layer up, in {@code ai.tessary.plan.CapabilityService}: the open edition serves every capability
 ...
 * therefore an opt-in. {@link ai.tessary.featureflags.FeatureFlags} deliberately has no {@code isOn} and
 ...
 * {@link ai.tessary.featureflags.DbFeatureFlags} is the OPEN adapter: per-org rows in
 ...
 *
 * <h2>Targeting</h2>
 * Global or one org, and nothing finer. {@link ai.tessary.featureflags.FlagContext} carries an org ULID

 ...
 * </ul>
 *
 * <p>Every default lives one layer up, in {@code ai.tessary.evals.plan.CapabilityService} (the open-edition
 ...
 *
 * <p>The sole consumer is {@code ai.tessary.evals.plan.CapabilityService}.
 */

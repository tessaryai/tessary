 ...
 * on {@link DbFeatureFlags}.</b> {@code EvalsApplication} is a bare {@code @SpringBootApplication} on
 * {@code ai.tessary.evals} with no {@code scanBasePackages}, so component scan sweeps every jar on the
 ...
 * because it sits inside {@code EvalsApplication}'s scan root, so Spring keeps the component-scanned

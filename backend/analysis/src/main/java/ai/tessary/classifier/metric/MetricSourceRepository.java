 ...
 * {@link ai.tessary.classifier.substrate.BehaviorSubstrateRepository} reads that one column; the
...
public class MetricSourceRepository {
     ...
     * ai.tessary.classifier.substrate.ActionSymbol} collapses every generation to the single symbol
     ...
     * to stay that way: the tool bucket key is an {@link ai.tessary.classifier.substrate.ActionSymbol},

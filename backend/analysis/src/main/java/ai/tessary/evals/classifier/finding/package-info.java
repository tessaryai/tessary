 ...
 * {@link ai.tessary.evals.classifier.finding.FindingService} serve every classifier; so does the
 ...
 *       {@link ai.tessary.evals.classifier.finding.TriageSource} and
 *       {@link ai.tessary.evals.classifier.finding.CauseResolver} are the two.
 ...
 *       {@link ai.tessary.evals.classifier.finding.BehaviorReadiness} stays open even though #919 moved
 ...
 * on the open side: it is {@link ai.tessary.evals.classifier.finding.FindingController} now, at

...
import ai.tessary.evals.classifier.catalog.BuiltInDetector.Kind;
import ai.tessary.evals.classifier.debug.ClassifierDebugDtos.BehaviorProfileDebugView;
import ai.tessary.evals.classifier.debug.ClassifierDebugDtos.ClassifierDebugView;
import ai.tessary.evals.classifier.debug.ClassifierDebugDtos.ClassifierDebugView.Family;
import ai.tessary.evals.classifier.debug.ClassifierDebugDtos.MetricBaselineView;
import ai.tessary.evals.classifier.debug.ClassifierDebugDtos.SketchSummary;
import ai.tessary.evals.classifier.debug.ClassifierDebugDtos.SweepView;

 ...
 *     ({@link ai.tessary.evals.classifier.metric.MetricWorkload}). The workload blobs rotate and
 ...
 *     cache-read share ({@link ai.tessary.evals.classifier.metric.MetricTokens}). A third blob per slot
...
public record MetricBaselineRow(
    ...
    public static final class Measure {
         ...
         * ({@link ai.tessary.evals.vitals.TokenPriceBook#billsCacheCreation}) rather than a provider

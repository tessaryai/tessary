 ...
 * <h2>The seam</h2>
 *
 * <p>{@link ai.tessary.evals.classifier.worker.ClassifierSweep} is the port,
 * {@link ai.tessary.evals.classifier.worker.ClassifierSweepRegistry} discovers its adapters, and
 * {@link ai.tessary.evals.classifier.worker.ClassifierWorker} routes a claimed job to one of them.
 * Three rules hold it, and they are the same three
 * {@code ai.tessary.evals.classifier.finding}'s package comment states for the read side:
 *
 * <ol>
 ...
 *       {@link ai.tessary.evals.classifier.worker.ClassifierSweepRegistry} for the irreversible

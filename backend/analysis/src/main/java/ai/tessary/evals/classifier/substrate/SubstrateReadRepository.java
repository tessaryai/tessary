...
import ai.tessary.evals.classifier.detector.GroundingEvidenceReads;
...
public class SubstrateReadRepository implements CallSiteSchemaReads, CallSiteShapeReads, GroundingEvidenceReads {
     ...
     *
     * <p>Deliberately separate from {@link ai.tessary.evals.onboarding.OnboardingRepository#trafficWindow},
    ...
    private static SubstrateObservation map(ResultSet rs) throws SQLException {
        return new SubstrateObservation(
                ...
                ai.tessary.evals.storage.Timestamps.iso(rs, "created_at"));
    }
}

...
import ai.tessary.evals.plan.RequiresCapability;
 ...
 * ({@code POST /cases/{id}/rca} — {@link ai.tessary.evals.cases.CaseController}), because that is the
...
public class RcaController {
    ...
    public ApiResponse<RcaReportView> rerun(
        ...
        String findingId = reports.findingIdOf(projectId, existing.jobId())
                .orElseThrow(() -> new EvalsException(RcaError.SUBJECT_NOT_FOUND, existing.subjectId()));

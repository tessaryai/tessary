 ...
 * each fanned out to by {@link ai.tessary.alert.channel.AlertDeliveryListener} when an
 * {@link AlertFiredEvent} commits.
 *
 * <p>{@code configEnc} holds SecretBox-sealed (AES-256-GCM, {@code tessary.secret-key}) channel config

 ...
 */
class GroundednessCaseSourceTest {

    private final GroundednessCaseSource source = new GroundednessCaseSource();

    @ParameterizedTest
    @ValueSource(strings = {"", "2026-09-01 00:00:00+00"})
    void anOnsetThatIsNotAnInstantOpensTheCaseUnbracketed(String onsetAt) {
        var finding = FindingRowBuilder.of(BuiltInDetector.Kind.GROUNDEDNESS)

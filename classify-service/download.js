...
(async () => {
  ...
  // problem, only a genuinely absent one. This is what makes the open-edition image build
  // without an HF_TOKEN at all (#877): the two private heads report themselves
